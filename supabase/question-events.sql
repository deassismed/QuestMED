...
revoke select on public.question_events from anon;
revoke select on public.question_events from authenticated;
...
group by local_day, area, tema
order by local_day desc, area asc, tema asc;
